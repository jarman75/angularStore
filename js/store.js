(function(angular){
    ...
    angular.module('store', ['store-products'])                        
        ...
        //     this.productlist = gems;
        //     var myJsonString = JSON.stringify(gems);
        ...
        .controller('StoreController', [ '$http', function ($http) {                                                                                              
           var store = this;           
           store.productlist = [ ]; //initialice products           
           
           $http.get('/products.json').then(sucessCallback, errorCallback);
           function sucessCallback(response){
              store.productlist = response.data;
